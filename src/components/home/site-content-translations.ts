...
export const SITE_T: Record<ListingLocale, SiteContentStrings> = {
  en: {
    ...
    hero: {
      ...
      title3: "across Europe",
      subtitle: "Used and new carousels, thrill rides, inflatables and arcade equipment — listed by operators, showmen and manufacturers. No brokers between you and the seller.",
  ...
  de: {
    ...
    hero: {
      ...
      title1: "Kaufen und verkaufen Sie",
      title2: "Fahrgeschäfte",
      title3: "in ganz Europa",
      subtitle: "Gebrauchte und neue Karussells, Fahrgeschäfte, Hüpfburgen und Spielautomaten — inseriert von Betreibern, Schaustellern und Herstellern. Kein Makler zwischen Ihnen und dem Verkäufer.",
  ...
  it: {
    ...
    hero: {
      ...
      title1: "Compra e vendi",
      title2: "giostre",
      title3: "in tutta Europa",
      subtitle: "Giostre nuove e usate, attrazioni, gonfiabili e giochi arcade — pubblicati da gestori, giostrai e produttori. Nessun intermediario tra te e il venditore.",
  ...
  fr: {
    ...
    hero: {
      ...
      title1: "Achetez et vendez des",
      title2: "attractions foraines",
      title3: "dans toute l'Europe",
      subtitle: "Manèges neufs et d'occasion, attractions à sensations, structures gonflables et machines d'arcade — publiés par des forains, exploitants et fabricants. Aucun intermédiaire entre vous et le vendeur.",
  ...
  es: {
    ...
    hero: {
      ...
      title1: "Compra y vende",
      title2: "atracciones feriales",
      title3: "en toda Europa",
      subtitle: "Carruseles, atracciones de emoción, hinchables y máquinas recreativas, nuevos y usados — publicados por operadores, feriantes y fabricantes. Sin intermediarios entre tú y el vendedor.",
  ...
  nl: {
    ...
    hero: {
      ...
      title1: "Koop en verkoop",
      title2: "kermisattracties",
      title3: "door heel Europa",
      subtitle: "Gebruikte en nieuwe draaimolens, spannende attracties, springkussens en arcade-apparatuur — geplaatst door exploitanten, kermisexploitanten en fabrikanten. Geen tussenpersoon tussen u en de verkoper.",
  ...
  pl: {
    ...
    hero: {
      ...
      title1: "Kupuj i sprzedawaj",
      title2: "atrakcje",
      title3: "w całej Europie",
      subtitle: "Używane i nowe karuzele, atrakcje ekstremalne, dmuchańce i automaty zręcznościowe — wystawiane przez operatorów, przedsiębiorców rozrywkowych i producentów. Żadnych pośredników między Tobą a sprzedawcą.",
  ...
  pt: {
    ...
    hero: {
      ...
      title1: "Compre e venda",
      title2: "atrações de diversão",
      title3: "em toda a Europa",
      subtitle: "Carrosséis, atrações radicais, insufláveis e máquinas de arcade, novos e usados — publicados por operadores, feirantes e fabricantes. Sem intermediários entre si e o vendedor.",
