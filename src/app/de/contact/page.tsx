...
const t = CONTACT_T.de

export const metadata: Metadata = {
  title: t.metaTitle,
  description: t.metaDescription,
  alternates: buildPageAlternates("/contact", "de"),
  openGraph: { url: "https://ridedirect.eu/de/contact", title: t.metaTitle, description: t.metaDescription },
}
