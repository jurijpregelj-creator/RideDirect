...
const TRUST = [
  { icon: "✅", text: "Gratis plaatsen" },
  { icon: "🌍", text: "Kopers in heel Europa" },
  { icon: "📩", text: "Directe aanvragen" },
  { icon: "💸", text: "Geen commissie" },
]

export default function ListYourRideNlPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#EEF4FF] to-white">
      <nav className="px-4 py-4 flex items-center justify-between max-w-5xl mx-auto">
        <a href="/nl" className="flex items-center gap-2">
          ...
          <div className="lg:pt-4 lg:sticky lg:top-8">
            ...
            <div className="bg-[#1E88E5]/8 border border-[#1E88E5]/20 rounded-2xl p-4 mb-8">
              ...
              <p className="text-gray-500 text-xs mt-1">
                Wees een van de eerste verkopers op Europa's marktplaats voor attracties.
              </p>
            </div>
            ...
            <p className="text-xs text-gray-400 mt-6">
              Sluit u aan bij verkopers uit 🇩🇪 🇮🇹 🇵🇱 🇳🇱 🇪🇸 en 20+ andere Europese landen.
            </p>
          </div>

          <div>
            <ListingFunnel lang="nl" />
          </div>
        </div>
      </div>
      ...
      <footer className="border-t border-gray-100 mt-12 py-6 text-center">
        <p className="text-xs text-gray-400">
          ...
          <a href="/legal/terms" className="hover:text-[#1E88E5]">Voorwaarden</a>
          {" · "}
