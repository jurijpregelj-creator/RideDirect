...
const t = CONTACT_T.fr

export const metadata: Metadata = {
  title: t.metaTitle,
  description: t.metaDescription,
  alternates: buildPageAlternates("/contact", "fr"),
  openGraph: { url: "https://ridedirect.eu/fr/contact", title: t.metaTitle, description: t.metaDescription },
}
