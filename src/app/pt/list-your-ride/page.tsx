...
export const metadata: Metadata = {
  title: "Publique a sua atração gratuitamente | RideDirect",
  description: "Venda a sua atração rapidamente. Publique gratuitamente e chegue a compradores sérios em toda a Europa. Sem comissão, sem necessidade de cartão.",
  alternates: funnelAlternates("pt"),
  openGraph: {
    type: "website",
    url: "https://ridedirect.eu/pt/list-your-ride",
    title: "Publique a sua atração gratuitamente | RideDirect",
    description: "Venda a sua atração rapidamente. Publique gratuitamente e chegue a compradores sérios em toda a Europa. Sem comissão, sem necessidade de cartão.",
  },
}
...
const TRUST = [
  { icon: "✅", text: "Publicação gratuita" },
  { icon: "🌍", text: "Compradores em toda a Europa" },
  { icon: "📩", text: "Pedidos diretos" },
  { icon: "💸", text: "Zero comissão" },
]

export default function ListYourRidePtPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#EEF4FF] to-white">
          ...
          <div className="lg:pt-4 lg:sticky lg:top-8">
            ...
            <div className="bg-[#1E88E5]/8 border border-[#1E88E5]/20 rounded-2xl p-4 mb-8">
              ...
              <p className="text-gray-500 text-xs mt-1">
                Seja um dos primeiros vendedores no marketplace europeu de atrações.
              </p>
            </div>
            ...
            <p className="text-xs text-gray-400 mt-6">
              Junte-se a vendedores de 🇩🇪 🇮🇹 🇵🇱 🇳🇱 🇪🇸 e mais de 20 outros países europeus.
            </p>
          </div>

          <div>
            <ListingFunnel lang="pt" />
          </div>
        </div>
      </div>
      ...
      <footer className="border-t border-gray-100 mt-12 py-6 text-center">
        <p className="text-xs text-gray-400">
          ...
          <a href="/legal/terms" className="hover:text-[#1E88E5]">Termos</a>
          {" · "}
          <a href="/legal/privacy" className="hover:text-[#1E88E5]">Privacidade</a>
        </p>
      </footer>
    </div>
  )
